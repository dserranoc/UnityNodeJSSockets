...
module.exports = class Server {
    ...
    //Interval update after 100 miliseconds
    onUpdate() {
        let server = this;
        //Update each lobby
    ...
    onAttemptToJoinGame(connection = Connection) {
        ...
        //All game lobbies full o we have never created one
        if(!lobbyFound){
    ...
    onSwitchLobby(connection = Connection, lobbyID) {
        ...
        connection.socket.join(lobbyID); //Join the new lobby's sockets channel
